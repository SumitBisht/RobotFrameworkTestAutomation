package org.sumitbisht.sampleapp;
...
public class SampleApp {
    ...
    public SampleApp(boolean introduceBugs) {
	...
	/**
	 * @param args Optional argument, if supplied with a string true,
	 * then runs the version of application containing bugs
	 */
	public static void main(String[] args) {
		if(args.length>0 && args[0].equalsIgnoreCase("true"))
			new SampleApp(true).display();
		new SampleApp(false).display();
	}
